...
var Sandbox = {
	...
	View : Backbone.View.extend({
		initialize: function(opts) {
			...
			this.placeholder = opts.placeholder || "// напиши javascript и нажми клавишу enter (:help - информация)";
			this.helpText = opts.helpText || " двигаться по истории - клавиши up/down, очистка консоля: `:clear` \n История: `JSON.stringify(sandbox.model.get('history'), 0, 4);` \n Префикс для ответа: `sandbox.resultPrefix = '&raquo; '`";
